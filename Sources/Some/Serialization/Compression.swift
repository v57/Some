...
public extension Data {
  func compress(_ algo: CompressionAlgorithm) -> Data? {
  ...
  func decompress(_ algo: CompressionAlgorithm) -> Data? {
    return self.withUnsafeBytes { (sourcePtr: UnsafePointer<UInt8>) -> Data? in
...
private struct Adler32: CustomStringConvertible {
