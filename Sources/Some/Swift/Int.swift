...
extension UInt {
  ...
  public static func seed() -> UInt { .seed(psd, .unique) }
...
extension Int {
  ...
  public static func seed() -> Int { .seed(psd, .unique) }
...
extension UInt64 {
  public static func random() -> UInt64 { random(in: min...max) }
...
extension UInt32 {
  public static func random() -> UInt32 { random(in: min...max) }
